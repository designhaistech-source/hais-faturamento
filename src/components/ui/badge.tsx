...
const badgeVariants = cva(
  "inline-flex items-center justify-center gap-1 rounded-full border px-2.5 text-xs font-semibold leading-none transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 whitespace-nowrap [&_svg]:shrink-0 icon-optical",

  {
    variants: {
      ...
      size: {
        sm: "px-2 pt-px h-6 text-xs [&_svg]:size-3",
        md: "px-2.5 pt-px h-7 text-xs [&_svg]:size-3.5",
        lg: "px-3 pt-px h-8 text-sm [&_svg]:size-4",
      },
    },
    defaultVariants: {
      variant: "default",
